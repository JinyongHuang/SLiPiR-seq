...
saveRDS(goi,"GOI-Breast cancer vs. others.rds")
ggplot(coef_filter, aes(x=apply.coef..1.....1..function.x..length.which.x....0...)) + 
  geom_histogram(color="black", fill="gray") + labs(x="Frequency of non-zero coefficient in 100 tests",y="# Gene of interest",title="BRC vs. Non-BRC")+
...
writeLines(goi_list[["cfRNA"]],"Breast cancer vs. Non-Breast cancer.txt")
...
####plot----
saveRDS(ML,"ML_results_Breast cancer vs. Non-Breast cancer.rds")
...
saveRDS(df_median,'BRC-Discovery cohort risk scores.rds')
