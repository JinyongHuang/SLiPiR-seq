...
saveRDS(goi,"GOI-Cancer vs. Non-cancer.rds")
ggplot(coef_filter, aes(x=apply.coef..1.....1..function.x..length.which.x....0...)) + 
  geom_histogram(color="black", fill="gray") + labs(x="Frequency of non-zero coefficient in 100 tests",y="# Gene of interest",title="Cancer vs. cancer-free")+
...
writeLines(goi_list[["cfRNA"]],"Cancer vs. Non-cancer.txt")
...
saveRDS(df_median,'Cancers-Discovery cohort risk scores.rds')
